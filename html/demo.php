  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="2000" >
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="../images/familyman.jpg" alt="Chicago" style="width:100%; height: 500px; transition-duration: 2s;">
        <div class="carousel-caption">
        <h1>The Family Man</h1>
        <pr> Action drama</pr>
      </div>
      </div>
      ...
      <div class="item">
        <img src="../images/findAttached.jpg" alt="Chicago" style="width:100%; height: 500px; transition-duration: 2s;">
        <div class="carousel-caption">
        <h1>Please Find Attached</h1>
        <pr> Drama, Romance, Roommates</pr>
      </div>
      </div>

      <div class="item">
        <img src="../images/bhaukaal.jpg" alt="Chicago" style="width:100%; height: 500px; transition-duration: 2s;">
        <div class="carousel-caption">
        <h1>Bhaukaal</h1>
        <pr>Crime Drama</pr>
      </div>
      ...
      <div class="item">
         <img src="../images/OperationMBBS.jpg" alt="Los Angeles" style="width:100%; height: 500px; transition-delay: 1s;">
        <div class="carousel-caption">
        <h1>Operation MBBS</h1>
        <pr>Drama College</pr>
      </div>
      </div>

      <div class="item">
         <img src="../images/cubicles.jpg" alt="Los Angeles" style="width:100%; height: 500px; transition-delay: 1s;">
        <div class="carousel-caption">
        <h1>Cubicles</h1>
        <pr>Drama office</pr>
      </div>
          ...
          <div class="card">
                          <img class="card-img-top" src="../html/uploads/'.$row["imageinput"].'" alt="card-image" width="200" height="250" >
                              <div class="card-body">
                               ...
                               <p><b> '.$row["genre"].' &nbsp;- '.$row["duration"].' <br>'.$row["rating"].'</b>
